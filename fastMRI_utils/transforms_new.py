...
def aHb(a,b):
#     last dimension is real and coplex dimensions
    copy_a = a.clone()
    copy_b = b.clone()
    ...
    real_sum = real_z.sum((-2,-1))
    imag_sum = imag_z.sum((-2,-1))
    
#     last dimension is real and coplex dimensions in the output as well
    return torch.stack([real_sum,imag_sum], dim=-1)

def real_part_of_aHb(a,b):
